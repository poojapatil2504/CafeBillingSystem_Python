...
pyttsx3.speak("Hello Friends Welcome TO Cafe Cauldron ")
...
lblInfo = Label(Tops, font=('Algerian', 20, 'bold','italic','underline'), fg="crimson",text="Cafe Cauldron", bd=10, anchor='w')
lblInfo.grid(row=0, column=0)
lblcopyright = Label(Bottoms, font=('Times New Roman', 10,'bold','italic'),fg="darkcyan", text="Created by- Pooja,Priyanka,Gayatri,Priyanka", bd=5, anchor='w')
...
subTotal.set(0)
totalPrice.set(0)
costvegBurgers.set(50)
costchickenBurgers.set(120)
costvegSandwich.set(50)
costnvegSandwich.set(80)
...
#==================================Order Info===========================
lblRef=Label(f1aa,font=('arial',12,'bold'),fg="midnightblue",text="Bill No", bd=16, justify='left')
...
ref_no=txtRef.get();
# --------------
lblVb=Label(f1aa,font=('arial',12,'bold'),fg="olive",text="Veg Burger", bd=16, justify='left')
...
# --------------
lblCb=Label(f1aa,font=('arial',12,'bold'),fg="firebrick",text="Chicken Burger", bd=16, justify='left')
...
# --------------
lblVs=Label(f1aa,font=('arial',12,'bold'),fg="olive",text="Veg Sandwich", bd=16, justify='left')
...
# --------------
lblCs=Label(f1aa,font=('arial',12,'bold'),fg="firebrick",text="Chicken Sandwich", bd=16, justify='left')
...
# --------------
lblVp=Label(f1aa,font=('arial',12,'bold'),fg="olive",text="Veg Pizza", bd=16, justify='left')
...
# --------------
lblCp=Label(f1aa,font=('arial',12,'bold'),fg="firebrick",text="Chicken Pizza", bd=16, justify='left')
...
# --------------
lblFf=Label(f1aa,font=('arial',12,'bold'),fg="olive",text="French Fries", bd=16, justify='left')
...
# --------------
lblSd=Label(f1aa,font=('arial',12,'bold'),fg="firebrick",text="Soft Drinks/Beverages", bd=16, justify='left')
...
#===================================Payment Info==========================
lbldate=Label(f1ab,font=('arial',12,'bold'),fg="midnightblue",text="Date", bd=16, justify='left')
...
date=txtdate.get();
# --------------
lblCvb=Label(f1ab,font=('arial',12,'bold'),fg="olive",text="Price of Veg Burger", bd=16, justify='left')
...
# --------------
lblCsd=Label(f1ab,font=('arial',12,'bold'),fg="firebrick",text="Price of Soft Drinks/Beverages", bd=16, justify='left')
...
# --------------
lblCvs=Label(f1ab,font=('arial',12,'bold'),fg="olive",text="Price of Veg Sandwich", bd=16, justify='left')
...
# --------------
lblCcs=Label(f1ab,font=('arial',12,'bold'),fg="firebrick",text="Price of Chicken Sandwich", bd=16, justify='left')
...
# --------------
lblCvp=Label(f1ab,font=('arial',12,'bold'),fg="olive",text="Price of Veg Pizza", bd=16, justify='left')
...
# --------------
lblCcp=Label(f1ab,font=('arial',12,'bold'),fg="firebrick",text="Price of Chicken Pizza", bd=16, justify='left')
...
# --------------
lblCcb=Label(f1ab,font=('arial',12,'bold'),fg="firebrick",text="Price of Chicken Burger", bd=16, justify='left')
...
# --------------
lblCff=Label(f1ab,font=('arial',12,'bold'),fg="olive",text="Price of French Fries", bd=16, justify='left')
...
#==========================Total Payment Info======
lblPrice=Label(f2aa,font=('arial',10,'bold'),fg="darkslategray",text="Price", bd=16, justify='left')
lblPrice.grid(row=0,column=0)
txtPrice=Entry(f2aa,font=('arial',10,'bold'),textvariable=subTotal, bd=10,insertwidth=2, justify='left')
txtPrice.grid(row=0,column=1)
# --------------
lblVat=Label(f2aa,font=('arial',10,'bold'),fg="darkslategray",text="Tax", bd=16, justify='left')
lblVat.grid(row=1,column=0)
txtVat=Entry(f2aa,font=('arial',10,'bold'),textvariable=vat, bd=10,insertwidth=2, justify='left')
txtVat.grid(row=1,column=1)
# --------------
lblTp=Label(f2aa,font=('arial',10,'bold'),fg="darkslategray",text="Total Price", bd=16, justify='left')
lblTp.grid(row=2,column=0)
txtTp=Entry(f2aa,font=('arial',10,'bold'),textvariable=totalPrice, bd=10,insertwidth=2, justify='left')
...
btnTotal=Button(f2ab,padx=16,pady=16,bd=8, fg="black",font=('arial',8,'bold'),width=15,
                text="Total Price",command=tPrice).grid(row=0,column=0)
btnBill=Button(f2ab,padx=16,pady=16,bd=8, fg="black",font=('arial',8,'bold'),width=15,
                text="Create Bill",command=entries).grid(row=0,column=1)
btnReset=Button(f2ab,padx=16,pady=16,bd=8, fg="black",font=('arial',8,'bold'),width=15,
                text="Reset",command=reset).grid(row=1,column=0)
btnExit=Button(f2ab,padx=16,pady=16,bd=8, fg="black",font=('arial',8,'bold'),width=15,
